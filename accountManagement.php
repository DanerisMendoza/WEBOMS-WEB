...
<body class="bg-light">
    <div class="container text-center mt-5">
        ...
        <button id="addButton" type="button" class="btn btn-lg btn-success col-12 mb-1" data-toggle="modal"
            data-target="#loginModal">Add new Account</button>
        <script>
            ...
            <table class="table table-striped table-bordered mb-5 col-lg-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-warning border-dark"
                                href="?update=<?php echo $row['username'].','.$row['email'] ?>">Update</a></td>
                        <td><?php if($row['username'] != 'admin'){?>
                            <a class="btn btn-danger border-dark"
                                href="?delete=<?php echo $row['user_id'] ?>">delete</a><?php } 
                            else
                ...
                <div class="modal-body ">
                    <form method="post" class="form-group">
                        ...
                        <button type="submit" class="btn btn-lg btn-success col-12"
                            name="updateNonAdmin">Update</button>
                    </form>
                </div>
            </div>
        </div>
